...
$.fn.themeswitcher = function(settings){
	...
	var button_default = {
		...
		//background: '#eee url(http://jqueryui.com/themeroller/themeswitchertool/images/buttonbg.png) 50% 50% repeat-x',
                background: '#eee url(/img/themes/buttonbg.png) 50% 50% repeat-x',
	...
	.find('.jquery-ui-themeswitcher-icon').css({
		...
		width: '16px',
		height: '16px',
		background: 'url(/img/themes/icon_color_arrow.gif) 50% 50% no-repeat'
	});	
	//pane css
	switcherpane.css({
		position: 'absolute',
	...
	.find('li').hover(
		function(){ 
			$(this).css({
				'borderColor':'#555',
				'background': 'url(/img/themes/menuhoverbg.png) 50% 50% repeat-x',
				cursor: 'pointer'
			}); 
		},
		function(){ 
