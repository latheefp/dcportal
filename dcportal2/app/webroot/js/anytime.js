/* anytimec.js 4.1112A (anytime.js 4.1112A
...
{_offCap=_offP;_offPSI=(-1);var era=1;var time=new Date(0,0,0,0,0,0,0);var slen=str.length;var s=0;var tzSign=1,tzOff=_offP;var i,matched,sub,sublen,temp;for(var f=0;f<_flen;f++)
{if(this.fmt.charAt(f)=='%')
