     ...
     if($val['mandate']=='1') {
           ...
           switch ($mytype) {
                case "string":
                        $type="text";
                        ?>
                        $('#addnew tbody').append('<?php print "<tr><td id=label>". $title ."</td><td id=inputdata>";?>  <input type= <?php print $type; ?> id=<?php print $name . "-addnew"; ?> validate=false name=<?php print $name; ?> maxlength=<?php print $length . "></td></tr>"; ?>');
                        <?php                                                      
                        break;
                ...
                case "select":
                       ...
                       // $list=explode(",", $val['extra']);
                        //print $list;
                        ?>
                        $('#addnew tbody').append('<?php print "<tr><td id=label>". $title ."</td><td id=inputdata> <select id=" . $name."-addnew  validate=false " . " name=" .$name;
                 ...
                 case "multiselect":
                       ...
                       // $list=explode(",", $val['extra']);
                        //print $list;
                        ?>
                        $('#addnew tbody').append('<?php print "<tr><td id=label>". $title ."</td><td id=inputdata> <select multiple id=" . $name ."-addnew  validate=false " . " name=" .$name;
                        if( isset($list[0])){$select = $list[0];}
                        //$options=' <option selected="selected"> '. $select .'</option>';
                        $options=' <option selected="selected"> '. $select .'</option>';
                        foreach($list as $key => $value):
    ...
    function validateForm(){
        ...
        $(':input','#dialog-addnew').each(function(){
           ...
           // var myfield=($(this).attr('name'));
            ...
            //var myval=($('#' + myfield + "-addnew").val());
           // alert (myid + " before Condition = " + validate);
            if (validate=="false"){
