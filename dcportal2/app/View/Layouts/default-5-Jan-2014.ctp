...
<span style="float:right;"> <input id="AdvSearch" style="font-size:9pt; width:150px; height:30px; padding-top:1px; padding-bottom: 1px;" type="button" value="Adv Search" onclick="AdvSearch()"></input>
</span>
</div>
            <div id="content">
