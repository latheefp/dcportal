...
<table id="tblServers">
            ...
            <!--        Multiselect menu codes starts here-->
            ...
            foreach($fieldUserInfo as $titble=>$value)
                {
                    ...
                    <td>
                        ...
                        <select  id="<?php echo  $value['field'] ?>" name="<?php echo  $value['field'] ?>" class="ui-multiselect"  >
                        
<!--           Need to add DB here to load data                 -->
...
<p id="paginator">
    <?php
    echo $paginator->first('« First ',array('class'=>'ui-state-default ui-corner-all'));
    ...
    function editRow(myTD){
        ...
        function submitMySettings(){
            ...
            $.ajax({
                type: "POST",
                cache: false,
                url: "<?php // echo $html->url(array("controller" => "users","action" => "update")); ?>",
...
?>
                ...
                $(function(){
                        $(<?php print '"#'.$value['field'].'"';?>).multiselect({ minWidth:'150', maxWidth:300,
                                                uncheckAllText:'UncheckAll', 
                                                height:'500',
                                                multiple:'true',
//                                                close: function(){
//                                                        var checkedValues = $(this).multiselect("getChecked");
//                                                        alert $checkedValues; }
